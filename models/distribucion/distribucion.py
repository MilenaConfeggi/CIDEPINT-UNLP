...
class Distribucion(db.Model):
    ...
    porcentaje_area = db.Column(db.Float, nullable=False)
    porcentaje_empleados = db.Column(db.Float, nullable=False)
    porcentaje_comisiones = db.Column(db.Float, nullable=False)
    ...
    #costos_de = db.relationship('Area', foreign_keys=[costos_de_id])